export const paragraphs = [
  ...
  "제2조(용어의 정의)",
  "1. 이 규정에서 “내부정보”라 함은 코스닥시장 공시규정(이하 “공시규정”이라 한다) 제1편에 의한 공시의무사항과 그 밖에 회사의 경영 또는 재산상황이나 투자자의 투자판단에 영향을 미칠 수 있는 사항을 말한다.",
  ...
  "제6조(공시담당자)",
  "1. 대표이사는 공시담당자를 정하여 한국거래소에 신고하여야 한다. 공시담당자를 변경한 때에도 또한 같다.",
  ...
  "제8조(내부정보의 사외제공)",
  "1. 임직원이 업무상의 이유로 회사의 거래상대방 외부감사인 대리인, 회사와 법률자문 및 경영자문 등의 자문계약을 체결하고 있는 자 등에 대하여 불가피하게 내부정보를 제공해야 하는 경우 공시책임자에게 이에 관한 사항을 보고하여야 한다.",
  ...
  "3. 언론의 보도내용이 사실과 다르다는 것을 알게 된 임원직원은 이를 공시책임자에게 보고하여야 한다.",
  ...
  "제5장 보 칙",
  "제17조(교육)",
  "공시책임자와 공시담당자는 공시규정 제36조 및 제44조제5항에 따른 공시업무에 관한 교육 등을 이수하여야 하고, 공시책임자는 교육내용을 관련 임직원에게 알려야 한다.",
  "제18조(규정의 개폐)",
